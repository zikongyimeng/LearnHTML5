...
Display$$module$cn$ucai$game2d$display$Display.prototype.getGlobalY=function(){var a=this.getParent();return a?a.getGlobalY()+this.y:0};Display$$module$cn$ucai$game2d$display$Display.prototype.internal_onClick=function(a){this.isEnabled()&&this.isVisible()&&this.hitTestPoint(a.layerX,a.layerY)&&(a=new module$cn$ucai$game2d$events$G2DMouseEvent["default"](module$cn$ucai$game2d$events$G2DMouseEvent["default"].CLICK),this.internal_dispatchEvent(a))};
Display$$module$cn$ucai$game2d$display$Display.prototype.internal_dispatchEvent=function(a){a.internal_setTarget(this);this.dispatchEvent(a);this.getParent()&&this.getParent().internal_dispatchEvent(a)};Display$$module$cn$ucai$game2d$display$Display.prototype.setEnabled=function(a){this._enabled=a};Display$$module$cn$ucai$game2d$display$Display.prototype.isEnabled=function(){return this._enabled};
Display$$module$cn$ucai$game2d$display$Display.prototype.internal_setParent=function(a){this._parent=a};Display$$module$cn$ucai$game2d$display$Display.prototype.getParent=function(){return this._parent};Display$$module$cn$ucai$game2d$display$Display.prototype.setVisible=function(a){this._visible=a};Display$$module$cn$ucai$game2d$display$Display.prototype.isVisible=function(){return this._visible};var $jscompDefaultExport$$module$cn$ucai$game2d$display$Display=Display$$module$cn$ucai$game2d$display$Display;
module$cn$ucai$game2d$display$Display["default"]=$jscompDefaultExport$$module$cn$ucai$game2d$display$Display;var module$cn$ucai$game2d$display$Rectangle={},Rectangle$$module$cn$ucai$game2d$display$Rectangle=function(a,b,c){module$cn$ucai$game2d$display$Display["default"].call(this);this._width=a;this._height=b;this._color=c};$jscomp.inherits(Rectangle$$module$cn$ucai$game2d$display$Rectangle,module$cn$ucai$game2d$display$Display["default"]);Rectangle$$module$cn$ucai$game2d$display$Rectangle.prototype.onDraw=function(a){a.fillStyle=this._color;a.fillRect(0,0,this._width,this._height)};
...
Game2dApp$$module$cn$ucai$game2d$app$Game2dApp.prototype.render=function(a){this._context2d.clearRect(0,0,this._stageWidth,this._stageHeight);this.internal_draw(this._context2d);requestAnimationFrame(this.render.bind(this))};Game2dApp$$module$cn$ucai$game2d$app$Game2dApp.prototype.getDom=function(){return this._canvas};var $jscompDefaultExport$$module$cn$ucai$game2d$app$Game2dApp=Game2dApp$$module$cn$ucai$game2d$app$Game2dApp;module$cn$ucai$game2d$app$Game2dApp["default"]=$jscompDefaultExport$$module$cn$ucai$game2d$app$Game2dApp;var module$cn$ucai$cardmemory$Card={},Card$$module$cn$ucai$cardmemory$Card=function(a,b,c){module$cn$ucai$game2d$display$Container["default"].call(this);this._num=a;this._faceA=new module$cn$ucai$game2d$display$Container["default"];this._faceABg=new module$cn$ucai$game2d$display$Rectangle["default"](b,c,"red");this._faceA.addChild(this._faceABg);this._text=new module$cn$ucai$game2d$display$Text["default"](""+a,30);this._faceA.addChild(this._text);this.addChild(this._faceA);this._faceB=new module$cn$ucai$game2d$display$Rectangle["default"](b,
c,"blue");this.addChild(this._faceB);this.showFaceA()};$jscomp.inherits(Card$$module$cn$ucai$cardmemory$Card,module$cn$ucai$game2d$display$Container["default"]);Card$$module$cn$ucai$cardmemory$Card.prototype.showFaceA=function(){this._faceA.setVisible(!0);this._faceB.setVisible(!1)};Card$$module$cn$ucai$cardmemory$Card.prototype.showFaceB=function(){this._faceA.setVisible(!1);this._faceB.setVisible(!0)};Card$$module$cn$ucai$cardmemory$Card.prototype.getNum=function(){return this._num};
var $jscompDefaultExport$$module$cn$ucai$cardmemory$Card=Card$$module$cn$ucai$cardmemory$Card;module$cn$ucai$cardmemory$Card["default"]=$jscompDefaultExport$$module$cn$ucai$cardmemory$Card;var module$cn$ucai$cardmemory$CardMemory={},CardMemory$$module$cn$ucai$cardmemory$CardMemory=function(){module$cn$ucai$game2d$app$Game2dApp["default"].call(this,400,300);document.body.appendChild(this.getDom());this._points=[];this._cardHeight=this._cardWidth=50;this._currentNum=1;this.restartGame()};$jscomp.inherits(CardMemory$$module$cn$ucai$cardmemory$CardMemory,module$cn$ucai$game2d$app$Game2dApp["default"]);
CardMemory$$module$cn$ucai$cardmemory$CardMemory.prototype.restartGame=function(){this._currentNum=1;this.removeAllChildren();this.generatePoints();this.addCards()};
CardMemory$$module$cn$ucai$cardmemory$CardMemory.prototype.addCards=function(){for(var a,b,c,d=1;5>=d;d++)a=new module$cn$ucai$cardmemory$Card["default"](d,this._cardWidth-2,this._cardHeight-2),c=Math.floor(Math.random()*this._points.length),b=this._points[c],this._points.splice(c,1),a.x=b.x,a.y=b.y,a.addEventListener("click",this.cardClickedHandler.bind(this)),this.addChild(a)};
CardMemory$$module$cn$ucai$cardmemory$CardMemory.prototype.cardClickedHandler=function(a){if(this._currentNum==a.getTarget().getNum()){this.removeChild(a.getTarget());if(1==this._currentNum)for(a=0;a<this.getChildrenCount();a++)this.getChildAt(a).showFaceB();this._currentNum++;0==this.getChildrenCount()&&(alert("\u6210\u529f\u4e86,\u6e38\u620f\u5c06\u91cd\u65b0\u5f00\u59cb"),this.restartGame())}else alert("\u70b9\u9519\u4e86")};
CardMemory$$module$cn$ucai$cardmemory$CardMemory.prototype.generatePoints=function(){for(var a=this._points.length=0;8>a;a++)for(var b=0;6>b;b++)this._points.push({x:this._cardWidth*a,y:this._cardHeight*b})};new CardMemory$$module$cn$ucai$cardmemory$CardMemory;var $jscompDefaultExport$$module$cn$ucai$cardmemory$CardMemory=CardMemory$$module$cn$ucai$cardmemory$CardMemory;module$cn$ucai$cardmemory$CardMemory["default"]=$jscompDefaultExport$$module$cn$ucai$cardmemory$CardMemory;
